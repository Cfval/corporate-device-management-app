...
const Landing1Page: React.FC = () => {
  ...
  return (
    <main className="relative min-h-screen bg-slate-50 text-slate-900 overflow-hidden">
      {/* SVG typographic background (1:1, fixed canvas) */}
      <img
        src={bgSvg}
        alt=""
        aria-hidden
      ...
      <section className="relative mx-auto grid min-h-screen max-w-7xl grid-cols-1 gap-16 px-6 py-24 lg:grid-cols-2 lg:items-center">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute -left-6 top-0 h-full w-px bg-slate-300/70" />
      ...
      <section className="relative mx-auto max-w-7xl px-6 pb-32">
        <motion.div
          ...
          transition={{ duration: 0.8, ease: "easeOut" }}
          className="grid gap-16 border-t border-slate-200 pt-20 sm:grid-cols-2 lg:grid-cols-3"
        >
          <div>
