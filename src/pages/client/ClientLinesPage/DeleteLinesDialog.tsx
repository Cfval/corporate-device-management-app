...
interface DeleteLinesDialogProps {
  open: boolean;
...
const DeleteLinesDialog: FC<DeleteLinesDialogProps> = ({
  open,
  selectedCount,
  loading,
  onClose,
    ...
    >
      ...
      <DialogContent dividers className="space-y-2 text-sm">
        <Typography className="text-slate-600 dark:text-slate-300">
          ...
          {selectedCount === 1 ? "línea" : "líneas"}? Esta acción no se puede
          deshacer.
        </Typography>
      </DialogContent>
...
export default DeleteLinesDialog;
